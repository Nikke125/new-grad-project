...
public class IdleItemModel implements Serializable {
     ...
     * 交易状态常量定义
     * 0: 在售 (Available)
     * 1: 被预订/交易中 (Reserved/Trading)
     * 2: 已售出 (Sold)
     * 3: 已下架 (Delisted)
     */
    public static final Integer STATUS_AVAILABLE = 0;      // 在售
    public static final Integer STATUS_RESERVED = 1;       // 被预订/交易中
    ...
    /**
     * 交易状态：0-在售, 1-被预订/交易中, 2-已售出, 3-已下架
     */
